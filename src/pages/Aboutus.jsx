            ...
            <div className="carousel w-1/2 my-10 mx-auto">
                    <div id="slide1" className="carousel-item relative w-full">
                        <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
                            ...
                            <p className='text-xl text-gray-600'>Teaching is a very noble profession that shapes the character, caliber, and future of an individual.</p>
                    ...
                    <div id="slide2" className="carousel-item relative w-full">
                         <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
                            ...
                            <p className='text-xl text-gray-600'>We dont get a chance to do that many things, and every one should be really excellent.</p>
                    ...
                    <div id="slide3" className="carousel-item relative w-full">
                        <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
                            ...
                            <p className='text-xl text-gray-600'>Success is a lousy teacher. It seduces smart people into thinking they can’t lose.</p>
                    ...
                    <div id="slide4" className="carousel-item relative w-full">
                        <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
                            ...
                            <p className='text-xl text-gray-600'>Education is the most powerful tool you can use to change the world.</p>
