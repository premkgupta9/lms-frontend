...
function Notfound() {
    ...
    return(
        <div className=" h-screen w-0full flex flex-col justify-center items-center ">
        <h1 className="text-9xl font-extrabold text-black">404
            </h1> 
        <div className="bg-white  absolute px-2 text-sm rounded rotate-12">
            Page not found...
            </div> 
